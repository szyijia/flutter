#ifndef FLUTTER_SHELL_COMMON_PATCHWING_SNAPSHOTS_DATA_HANDLE_H_
#define FLUTTER_SHELL_COMMON_PATCHWING_SNAPSHOTS_DATA_HANDLE_H_
...
#endif  // FLUTTER_SHELL_COMMON_PATCHWING_SNAPSHOTS_DATA_HANDLE_H_
