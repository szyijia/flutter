...
void main() {
  ...
  testWithoutContext(
    ...
    () async {
      ...
      expect(downloads, <String>[
        'https://cdn.patchwing.net/patchwing/branded-v2/flutter_infra_release/flutter/hijklmnop/flutter-web-sdk.zip',
      ]);
  ...
  testWithoutContext('FlutterEngineStamp fetches engine_stamp.json', () async {
    ...
    expect(downloads, <String>[
      'https://cdn.patchwing.net/patchwing/branded-v2/flutter_infra_release/flutter/hijklmnop/engine_stamp.json',
    ]);
